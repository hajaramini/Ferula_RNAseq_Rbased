...
write.csv(counts, file="/Users/hajaramini/Ferula_RNAseq_Rbased/input/Ferula_RNAseq.coutns.csv")
...
write.csv(counts.small, file="/Users/hajaramini/Ferula_RNAseq_Rbased/input/Ferula_RNAseq.coutns.small.csv") # use this for other analysis
...
p.DEGs2
ggsave(p.DEGs2, file="/Users/hajaramini/Ferula_RNAseq_Rbased/output/Ferula_RNAseq.p.DEG2.png")
...
<<<<<<< HEAD
```{r}
genes <- read.delim("~/Downloads/uniprot-yourlist%3AM20170612AAFB7E4D2F1D05654627429E83DA5CCEB9AC09P.tab.gz")
unique(genes$Protein.names)
```
=======

genes <- read.delim("~/Downloads/uniprot-yourlist%3AM20170612AAFB7E4D2F1D05654627429E83DA5CCEB9AC09P.tab.gz")
unique(genes$Protein.names)
>>>>>>> a05dc81015313e035d3f60c51bbcf9284b9c702c
