...
```
#import data
counts <- read.csv ("/Users/hajaramini/Ferula_RNAseq_Rbased/input/combined_counts.csv", header=T, check.names = F) 
head(counts)
colnames(counts)
rownames(counts)
# make the 1st column as rownames
counts <- read.csv("/Users/hajaramini/Ferula_RNAseq_Rbased/input/combined_counts.csv", header=T, row.names="target_id")
test1=read.table("/Users/hajaramini/Ferula_RNAseq_Rbased/input/combined_counts.csv",header=T,row.names=1)
head(counts)
colnames(counts)[1] 
rownames(counts)
...
counts.low<-counts[colSums(counts,na.rm=TRUE) < 1000000],]
...
samples.small <- data.frame(file=colnames(counts.small),
                      batch=factor(sub("(A|B|C|D)(S|F|L|R)(2|3|6)","\\1",colnames(counts.small))),
...
head(samples.small)
write.csv(counts.small, file="/Users/hajaramini/Ferula_RNAseq_Rbased/input/Ferula_RNAseq.coutns.small.csv") # use this for next analysis
save(samples.small,file="/Users/hajaramini/Ferula_RNAseq_Rbased/input/Ferula_RNAseq.samples.small.Rdata")
...
save(dge,file="/Users/hajaramini/Ferula_RNAseq_Rbased/output/dge.Rdata")
plotBCV(dge)
...
head(DEgenes1)
#save to a file
write.csv(DEgenes1,file="/Users/hajaramini/Ferula_RNAseq_Rbased/output/Ferula_RNAseq.DEgenes1.csv")
...
DEGs1
save(DEGs1, file="/Users/hajaramini/Ferula_RNAseq_Rbased/output/Ferula_RNAseq.DEGs1.Rdata")
#library(reshape2)
#library(ggplot2)
...
p.DEGs1
ggsave(p.DEGs1, file="/Users/hajaramini/Ferula_RNAseq_Rbased/output/Ferula_RNAseq.p.DEG1.png")
...
DEGs2
save(DEGs2, file="/Users/hajaramini/Ferula_RNAseq_Rbased/output/Ferula_RNAseq.DEGs2.Rdata")
#library(reshape2)
#library(ggplot2)
...
p.DEGs2
ggsave(p.DEGs12, file="/Users/hajaramini/Ferula_RNAseq_Rbased/output/Ferula_RNAseq.p.DEG2.png")