---
title: "RNASeq_Ferula_Kallisto_DEG_Drap_Trinity"
output: 
  html_document: 
    keep_md: yes
---
...
counts_All <- read.csv("~/Ferula_RNAseq_Rbased/Kallisto_out/combined_Plant6_counts_kallisto.csv", header=T , row.names = "target_id")
